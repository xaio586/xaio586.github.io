const CACHE_VERSION='ielts-pages-v15';
const SHELL=['/','/styles.css?v=20260916-26','/app.js?v=20260917-01','/webgl-background.js','/vendor/gsap-3.13.0.min.js','/favicon.svg','/manifest.webmanifest','/static-api.js','/site-data.json','/icons/apple-touch-icon.png','/icons/icon-192.png','/icons/icon-512.png','/assets/audio/kokoro/unlock.mp3'];
